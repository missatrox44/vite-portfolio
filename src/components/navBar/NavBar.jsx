...
export default function NavBar(){
  return(
<header>
    <nav class='bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-darkDesert'>
        <div class='flex flex-wrap justify-between items-center mx-auto max-w-screen-xl'>
            <a href='#' class='flex items-center'>
                <img src='./public/dev-icon.svg' class='mr-3 h-6 sm:h-9' alt='Sara Dev Logo' />
                <span class='self-center text-xl font-semibold whitespace-nowrap dark:text-white'>sarabaqla.dev</span>
            </a>
